package contest.EducationalCodeforcesRound48;
...
/***********************
 ...
 @date: 2021/2/5 16:26
 @url: https://codeforc.es/problemset/problem/1016/B
 ***********************/
    ...
    void go() {
        ...
        for (int i = 0; i < q; i++) {
            ...
            if (r - l + 1 < m) {
                ...
                Integer[] leftPos = left.toArray(new Integer[]{});
                Integer[] rightPos = right.toArray(new Integer[]{});
                int lowbound = lowbound(0, leftPos.length, l, leftPos);
                int upperbound = upperbound(0, rightPos.length, r, rightPos);
                ans[i] = upperbound - lowbound;
            }
        }
        for (int x : ans) {
            out.println(x);
