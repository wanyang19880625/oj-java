package contest.CodeforcesGlobalRound16;
 ...
 * @date: 2021/9/12 23:06
 * @url: https://codeforc.es/contest/1566/problem/C
 ***********************/
public class C1556 {
    InputStream is;
    FastWriter  out;
    ...
    void go() {
        ...
        for (int i = 1; i < n; i++) {
            if (!visit[i - 1] && res[i] == 1 && res[i - 1] == 0) {
                res[i] = 2;
                visit[i - 1] = true;
                visit[i] = true;
            }
            if (!visit[i - 1] && res[i] == 0 && res[i - 1] == 1) {
                res[i - 1] = 2;
                visit[i - 1] = true;
                visit[i] = true;
            }
