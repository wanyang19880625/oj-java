package contest.CodeforcesRound704;
 ...
 * @url: https://codeforc.es/contest/1492/problem/A
 ***********************/
...
public class A {
    ...
    void go() {
        ...
        if (p % a == 0 || p % b == 0 || p % c == 0) {
            ...
            long x = p / a, y = p / b, z = p / c;
            long ans = Math.min((x + 1) * a - p, (y + 1) * b - p);
            ans = Math.min(ans, (z + 1) * c - p);
            out.println(ans);
        }
    }
