package contest.CodeforcesRound725;
 ...
 * @url: https://codeforc.es/contest/1538/problem/D
 ***********************/
public class D1538 {
    ...
    void go() {
        ...
        int counta = getPrimeFactor(a, primes);
        int countb = getPrimeFactor(b, primes);
        if (k <= counta + countb) {
            out.println("YES");
        } else {
            out.println("NO");
...
//        }
    ...
    int getPrimeFactor(int n, List<Integer> primes) {
        int num = n;
        int count = 0;
        for (int p : primes) {
            if (p * p > num) {
