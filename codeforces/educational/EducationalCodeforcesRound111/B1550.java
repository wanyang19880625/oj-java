package educational.EducationalCodeforcesRound111;
 ...
 * @date: 2021/7/14 22:49
 * @url: https://codeforc.es/contest/1550/problem/B
 ***********************/
...
public class B1550 {
    ...
    void go() {
        ...
        if (b >= 0) {
            ...
            int min = Math.min(zero, one) + 1;
            out.println(min * b + ans);
        }
    }
